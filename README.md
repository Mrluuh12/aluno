...
python3 teste_parser.py                        # 481 testes
```
...
| `teste_parser.py` | 481 testes; roda sem rádio e sem a lib `rajant_api` |
...
> novas funcionarem.
>
> Verificado com o programa inteiro em Python 3.13: 481 testes, geração de PPT
